...
class PersonService {
    ...
    async findPlayer(displayname: string): Promise<PlayerSimple> {
        try {
            let user:PlayerFull = await this.findUser({ displayname });
    ...
    async findPlayerRanks(shortid: string): Promise<PlayerRank[]> {
        try {
    ...
    async findPlayerDevGames(shortid:string): Promise<DeveloperGameSimple[]> {
        try {
            let db = await mysql.db();
    ...
    async friendRequest(personid:string, friendid:string, db?:any) {
        try {
    ...
    async deleteFriend(personid:string, friendid:string, db?:any) {
        try {
            db = db || (await mysql.db());
    ...
    async friendResponse(personid:string, friendid:string, statusid:number, db?:any) {
        try {
            db = db || (await mysql.db());
    ...
    async getFriends(shortid:string): Promise<Friend[]> {
        try {
            let db = await mysql.db();
            let user = null;
    ...
    async findUser(user:PlayerSearchRequest, isSimple:boolean): Promise<PlayerFull> {
        try {
            let db = await mysql.db();
            let response;
            if (user.id) {
    ...
    async findOrCreateUser(user: PlayerSearchRequest): Promise<PlayerFull> {
        try {
    ...
    async createDisplayName(user: PlayerFull, db?: any): Promise<PlayerFull> {
        try {
            db = db || (await mysql.db());
    ...
    async deleteUser(user:PlayerSearchRequest, db?: any): Promise<boolean> {
        try {
            db = db || (await mysql.db());
    ...
    async updateUser(user: Partial<PlayerFull>, db?: any): Promise<PlayerFull> {
        try {
            db = db || (await mysql.db());
            let shortid = user.shortid;
            delete user["shortid"];
    ...
    async createUser(user: Partial<PlayerFull>, db?: any): Promise<PlayerFull> {
        try {
            db = db || (await mysql.db());
    ...
    async inviteToGithub(user: PlayerSearchRequest) {
    ...
    async createGithubUserTeam(user: PlayerSearchRequest) {
        if (!("github" in user) || !user.github) {
            return;
        }
